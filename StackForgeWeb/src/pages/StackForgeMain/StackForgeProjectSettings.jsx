...
import { faArrowUpRightFromSquare, faUserGear, faUsersGear, faPersonChalkboard, faLock, faChartColumn, faMoneyBills, faGear, faBookmark, faPenToSquare, faClone, faSquareCheck, faGears, faIdCard, faMagnifyingGlass, faSearch, faCircleInfo, faCaretDown } from "@fortawesome/free-solid-svg-icons";
...
const StackForgeProjectSettings = () => {
    ...
    const [domainEditStates, setDomainEditStates] = useState({});
    ...
    useEffect(() => {
        domains.forEach(domain => {
            ...
            if (redirectDropdownOpen[domainID] && redirectButtonRefs.current[domainID] && redirectDropdownRefs.current[domainID]) {
            ...
            if (environmentDropdownOpen[domainID] && environmentButtonRefs.current[domainID] && environmentDropdownRefs.current[domainID]) {
    ...
    const fetchDomains = async () => {
        ...
        try {
            ...
            setDomains(data.domains.map(domain => ({
                ...domain,
                environment: domain.environment
                    ? domain.environment.charAt(0).toUpperCase() + domain.environment.slice(1).toLowerCase()
                    : domain.environment
            })) || []);
            const editStates = {};
            const recordStates = {};
            (data.domains || []).forEach(domain => {
                editStates[domain.domainID] = "normal";
                recordStates[domain.domainID] = "ARecord";
            });
            setDomainEditStates(editStates);
    ...
    const updateRedirect = async (domainID, redirectTarget) => {
        ...
        try {
            ...
            setDomains(prev => prev.map(d => 
                d.domainID === domainID ? { ...d, redirectTarget } : d
            ));
        } catch (error) {
            await showDialog({
                title: "Error",
    ...
    const updateEnvironment = async (domainID, environment) => {
        ...
        try {
            ...
            setDomains(prev => prev.map(d => 
                d.domainID === domainID ? { ...d, environment } : d
            ));
        } catch (error) {
            await showDialog({
                title: "Error",
                    ...
                    <div className="projectSettingsCellContentWrapper">
                        <div className="projectSettingsContentSideBar">
                            <div className="projectSettingsSideBarButtonWrapper">
                                ...
                                <button className={"projectSettingsSideBarButton " + (settingsState === "domains" ? "projectSettingsSideBarButton--selected" : "")} onClick={() => setSettingsState("domains")}>
                                    <span>
                            ...
                            <div className="projectSettingsContentMainScroll" ref={scrollContainerRef}>
                                {settingsState === "general" && (
                                    <>
                                        ...
                                        <div className="projectSettingsContentFlexCell">
                                            <div className="projectSettingsContentFlexCellTop">
                                                <div className="projectSettingsLeadingCellStack">
                                                    <h3>Project Info</h3>
                                                    <p>
                                                        This is the name and project ID associated with your project. You can not change the project ID assigned by Stackforge.
                                                    </p>
                                                </div>
                                                <div className="projectSettingsTrailingCellStack" style={{ justifyContent: "center", alignItems: "center" }}>
                                        ...
                                        <div className="projectSettingsContentFlexCell" style={{ border: "1px solid #E54B4B" }}>
                                            <div className="projectSettingsContentFlexCellTop">
                                                <div className="projectSettingsLeadingCellStack" style={{ width: "100%" }}>
                                                    <h3>Delete Project</h3>
                                                    <p style={{ width: "100%" }}>Permanently delete this project and all of its contents from the platform. This is irreversible.</p>
                                                    <button className="projectSettingsDeleteButton" onClick={handleProjectDelete}>
                                                        Delete Project
                                                    </button>
                                                </div>
                                            </div>
                                            <div className="projectSettingsContentFlexCellBottom" style={{ borderTop: "1px solid #E54B4B", backgroundColor: "rgba(229, 75, 75, 0.2)" }}>
                                    ...
                                    <>
                                        {domainsLoading && domains.length === 0 ? (
                                            ...
                                            domains.map(domain => {
                                                ...
                                                const selectedRecordType = recordTypeMap[selectedDomainStates[domain.domainID]];
                                                const dnsRecord = (domain.dnsRecords || []).find(record => record.type === selectedRecordType);

                                                return (
                                                    <div key={domain.domainID} className="projectSettingsContentFlexCellStack">
                                                        <div className="projectSettingsDomainHeader">
                                                            ...
                                                            <div>
                                                                <button 
                                                                    ...
                                                                    onClick={() => validateDomain(domain.domainID, domain.domainName)}
                                                                    disabled={domainLoadingStates[domain.domainID]}
                                                                >
                                                                    {domainLoadingStates[domain.domainID] ? "..." : "Refresh"}
                                                                </button>
                                                                <button 
                                                                    style={{ "background-color": "rgba(255,255,255,0.1)" }}
                                                                    onClick={() => {
                                                                        setDomainEditStates(prev => ({
                                                                            ...prev,
                                                                            [domain.domainID]: prev[domain.domainID] === "normal" ? "edit" : "normal"
                                                                        }));
                                                                    }}
                                                                >
                                                                    {domainEditStates[domain.domainID] === "normal" ? "Edit" : "Cancel"}
                                                                </button>
                                                            </div>
                                                        </div>
                                                        {domainEditStates[domain.domainID] === "normal" && (
                                                            <div className="projectSettingsDomainContent">
                                                                <div className="projectSettingsRecordStatusBar">
                                                                    <button 
                                                                        ...
                                                                        style={{ "border-bottom": (selectedDomainStates[domain.domainID] === "ARecord" ? "2px solid #c1c1c1" : "none") }}
                                                                    >
                                                                        A Record
                                                                    </button>
                                                                    <button 
                                                                        ...
                                                                        style={{ "border-bottom": (selectedDomainStates[domain.domainID] === "AAAARecord" ? "2px solid #c1c1c1" : "none") }}
                                                                    >
                                                                        AAAA Record
                                                                    </button>
                                                                    <button 
                                                                        ...
                                                                        style={{ "border-bottom": (selectedDomainStates[domain.domainID] === "CNameRecord" ? "2px solid #c1c1c1" : "none") }}
                                                                    >
                                                                        CName Record
                                                                    </button>
                                                                </div>
                                                                ...
                                                                <div className="projectSettingsRecordInfo">
                                                                    {dnsRecord ? (
                                                                        <>
                                                                            <p>Type<br /> <i>{dnsRecord.type}</i></p>
                                                                            <p>Name<br /> <i>{dnsRecord.name}</i></p>
                                                                            <p>Value<br /> <i>{dnsRecord.value}</i></p>
                                                                        </>
                                                                    ) : (
                                                        ...
                                                        {domainEditStates[domain.domainID] === "edit" && (
                                                            <div className="projectSettingsDomainContent" style={{ "justify-content": "flex-start", "align-items": "center" }}>
                                                                <label>
                                                                    ...
                                                                    <div className="projectSettingsDropdownWrapper">
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <FontAwesomeIcon
                                                                                ...
                                                                                style={{
                                                                                    transform: redirectDropdownOpen[domain.domainID] ? "rotate(180deg)" : "rotate(0deg)",
                                                                        ...
                                                                        {redirectDropdownOpen[domain.domainID] && (
                                                                            ...
                                                                            >
                                                                                <button 
                                                                                    onClick={() => handleRedirectSelect(domain.domainID, null)}
                                                                                >
                                                                                    <i>None</i>
                                                                                    <FontAwesomeIcon icon={faArrowUpRightFromSquare} />
                                                                                </button>
                                                                    ...
                                                                    <div className="projectSettingsDropdownWrapper">
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <FontAwesomeIcon
                                                                                ...
                                                                                className="projectSettingsDomainCaretIcon"
                                                                                style={{
                                                                                    transform: environmentDropdownOpen[domain.domainID] ? "rotate(180deg)" : "rotate(0deg)",
                                                                                    transition: "transform 0.3s ease"
                                                                                }}
                                                                            />
                                                                        </button>
